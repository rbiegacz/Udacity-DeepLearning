...
def test_folder_path(cifar100_dataset_folder_path):
    print("Data stored in: ")
    print(cifar100_dataset_folder_path)
    print("\n")
    
    assert cifar100_dataset_folder_path is not None,\
        'Cifar-100 data folder not set.'
    assert cifar100_dataset_folder_path[-1] != '/',\
        'The "/" shouldn\'t be added to the end of the path.'
    assert os.path.exists(cifar100_dataset_folder_path),\
        'Path not found.'
    assert os.path.isdir(cifar100_dataset_folder_path),\
        '{} is not a folder.'.format(os.path.basename(cifar100_dataset_folder_path))

    train_files = [cifar100_dataset_folder_path + '/train']
    other_files = [cifar100_dataset_folder_path + '/test', cifar100_dataset_folder_path + '/meta']
